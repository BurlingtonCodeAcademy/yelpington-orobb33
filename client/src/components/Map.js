  ...
  return (
    <div id="Map">
      ...
      >
        ...
        <Marker position={[44.47719192504883, -73.21509552001953]} icon={glassIcon}>
          <Popup>
        ...
        <Marker position={[44.47576141357422, -73.212646484375]} icon={glassIcon}>
          <Popup>
            <Link to={`/bars/manhattans`}>Manhattan's</Link>
          </Popup>
        </Marker>

        <Marker position={[44.476688385009766, -73.2142562866211]} icon={glassIcon}>
          <Popup>
